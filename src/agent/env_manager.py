...
import os
from src.environments.prompts import *
from src.environments.base import EnvironmentManagerBase, to_numpy
from src.memory import SimpleMemory, SearchMemory
...
def make_envs(config):
    ...
    if "search" in config.env.env_name.lower():
        from src.environments.env_package.search import build_search_envs, search_projection
        ...
        from src.environments.env_package.gym_cards import build_gymcards_envs, gym_projection
        ...
        from src.environments.env_package.alfworld import build_alfworld_envs, alfworld_projection
        ...
        from src.environments.env_package.sokoban import build_sokoban_envs, sokoban_projection
        env_kwargs = {
        ...
        from src.environments.env_package.webshop import build_webshop_envs, webshop_projection
        ...
        from src.environments.env_package.appworld import build_appworld_envs, appworld_projection
