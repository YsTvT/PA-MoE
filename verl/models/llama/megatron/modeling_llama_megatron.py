...
class ParallelLlamaForCausalLMRmPad(nn.Module):
    ...
    def forward(
        ...
        input_ids, indices, cu_seqlens, max_seqlen_in_batch, *_ = unpad_input(input_ids.unsqueeze(dim=-1), attention_mask)
...
class ParallelLlamaForCausalLMRmPadPP(nn.Module):
    ...
    def forward(
        ...
        *,
        ...
        batch_size, sequence_length = input_ids.shape
        input_ids_rmpad, indices, cu_seqlens, max_seqlen_in_batch, *_ = unpad_input(input_ids.unsqueeze(dim=-1), attention_mask)
