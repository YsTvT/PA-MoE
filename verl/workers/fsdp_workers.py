...
class ActorRolloutRefWorker(Worker):
    ...
    def _build_model_optimizer(
        ...
        if self.config.model.get('use_moe', False) and role == "actor":
            use_phase_moe = self.config.model.get('use_phase_moe', False)
            ...
            if use_phase_moe:
                ...
                num_experts = self.config.model.phase_moe.get('num_experts', 4)
                
                actor_module = wrap_as_phase_moe(
